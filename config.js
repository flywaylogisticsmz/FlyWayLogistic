...
const FLY_CONFIG = {
  ...
  sheets: {
    // ════════════════════════════════════════════════════════════════════════
    // COLE AQUI O URL DO SEU GOOGLE APPS SCRIPT
    // Formato: 'https://script.google.com/macros/s/XXXXXXX/exec'
    //
    // Este é o campo mais importante do ficheiro.
    // Quando preenchido, QUALQUER pessoa que abra o site (incluindo clientes)
    // consegue pesquisar encomendas sem qualquer configuração adicional.
    //
    // Passos:
    //  1. Cole o URL abaixo (entre as plicas)
    //  2. Guarde o ficheiro
    //  3. Faça upload/push para o GitHub
    //  4. O site fica imediatamente funcional para todos
    // ════════════════════════════════════════════════════════════════════════
    urlFixo: 'https://script.google.com/macros/s/AKfycbwNu4JvKdJRY51dyMH4AufEXIf3WA5PP1VyWWy-w-uC1tNWSIMoCymLg6DJbiN8kmG3/exec',
    // Exemplo:
